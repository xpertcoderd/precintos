    ...
    <main class="bg-white rounded-2xl shadow-lg p-6">
      <div class="flex flex-col md:flex-row justify-between items-center mb-6">
        <div class="flex items-center gap-3">
          <!-- Inlined ChipIcon -->
          <svg class="w-6 h-6 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3H4a1 1 0 00-1 1v5zM9 3a2 2 0 012 2v2m0 0V5a2 2 0 012-2h5a1 1 0 011 1v5m-6 0h6m-6 0a2 2 0 00-2 2v2m0 0V19a2 2 0 002 2h5a1 1 0 001-1v-5m-6 0h6"></path></svg>
...
import ConfirmationModal from '@/components/DispositivoPage/components/ConfirmationModal.vue'
