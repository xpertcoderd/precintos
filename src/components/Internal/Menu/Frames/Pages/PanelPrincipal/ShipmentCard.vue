<template>
  <div class="w-full mb-2 bg-slate-50 rounded-lg transition-all duration-300 p-3 border border-slate-200">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-slate-200 pb-3 mb-3">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start gap-3">
      <div class="w-full">
        <h3 class="text-sm font-semibold text-slate-600 mb-2">Route</h3>
      ...
      <div class="flex-shrink-0 flex flex-row items-center gap-3 pt-1 md:pt-0">
        <div @click="$emit('groupContainers', shipmentData)" class="flex items-center gap-1 text-xs font-medium text-slate-600 cursor-pointer hover:text-sky-600">
